...
> >
> > **cust_get_data_list【1.9】：** 该功能用于支持自定义加载tree的初始化数据，如果该项存在，则将屏蔽sql_key的加载数据功能，包含属性clazz(指定的加载类和静态方法),param(入参)示例将在下面展示；
> >
...
* 1.加载标签：
        <@tree  size="12" 
                ...
                edit_flag="true"
                cust_get_data_list={
                "clazz":"com.cnnct.utils.CustRepSysTagDataUtils[getTreeDataList]",
                "param":"123"
                }
                />
