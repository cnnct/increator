...
> >
> > * url字段说明：当菜单级别为按钮级别时，url值不需要再填写url，只需要填写一个唯一标识、且能简明表达当前菜单意义的单词组合即可，规则为全小写，单词间用下划线分隔即可。使用时需要结合权限按钮使用，详见“[button标签](/ji-ben-biao-dan-kong-jian/buttonbiao-qian-3010-shi-3011.md)”。
>
> #### 系统类方法名命名规则
>
> > controller类名命名
