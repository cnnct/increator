...
* **Parameters:**
  * `codeType` — code\_Type名称，如SEX
  * `codeValue` — code\_Value值
* **Returns:** code\_Name值
...
* **Parameters:** `paraCode` — para\_Code名称，如LOGIN\_TIME\_OUT
* **Returns:** Sys\_Para.para\_Value值，如30
...
* **Parameters:** `trCode` — 交易代码，如110013
* **Returns:** Sys\_Code\_Tr.code\_Name值
